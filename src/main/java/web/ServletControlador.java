...
public class ServletControlador extends HttpServlet{
    ...
    */
    private void accionDefault(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        // request.getRequestDispatcher("clientes.jsp").forward(request, response);   se envia la información al archivo clientes.jsp // cuando se produce la acción de insertar la información se queda ahí y en caso de que se recarge la página la información se vuelve a insertar en la base de datos t produce un doble registro(para mas informacion ver el curso Academia java - De cero a experto con Ejercicios, Sección 66 Servlets y JSP´s: Proyecto Final Control Clientes, video número 254 minuto 17)
